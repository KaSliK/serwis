...
@section('content')
        ...
        <a href="{{route('examples.index')}}"><i class="fas fa-arrow-left arrowBack"></i></a>
        <p style="font-size: 3rem;" class="text-center font-weight-bolder">

            Galeria {{$example->title}}
        </p>
    ...
    <div class="col-sm-12 col-md-8">
        <div class="row">
            @foreach($example->photos as $photo)
                ...
                <a class="elem" href="{{asset($photo->path)}}" title="{{$example->title}}" data-lcl-txt="{{$photo->alt}}" data-lcl-thumb="{{asset($photo->path)}}">
        ...
        <div class="col-sm-12 col-md-4">
            ...
            <div class="file-field ">
                ...
                <input type="hidden" id="title" name="title" value="{{$example->title}}">
